...
// 節點設定
	...
	showXHTML_table_B('border="0" cellpadding="3" cellspacing="1" style="z-index:84;" class="box01 bg04" width="560" id="nodeSetupTable" ');
		// 節點類型
		showXHTML_tr_B('class="bg03 font01"');
		...
		showXHTML_tr_B('class="bg04 font01"');
                    ...
                    showXHTML_td_B('');
                        ...
                        showXHTML_input('text', 'url', 'about:blank', '', 'size="35" maxlength="255" class="box02" id="url"');
