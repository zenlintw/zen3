...
<frameset cols="200,*" framespacing="1" frameborder="no" bordercolor="black" id="fs1">
  <frame name="left" id="left" scrolling="auto" frameborder="no" target="rtop" src="exam_correct_user.php?<?php echo $ticket . '+' . $_POST['lists'];?>">
  <frameset rows="30%,*" framespacing="1" frameborder="no" bordercolor="black" noresize>
    <frame name="rtop" id="rtop" frameborder="no" target="rbottom" src="about:blank">
    <frame name="rbottom" id="rbottom" frameborder="no" src="about:blank">
  </frameset>
  <noframes>
  <body>
	<div id ="test2"></div>
