 ...
 * @author $Author: saly $
 * @version $Id: config.inc.php,v 1.1 2010/02/24 02:39:59 saly Exp $
...
*/
$IMConfig['base_dir'] = $_SERVER["DOCUMENT_ROOT"].'/base/'.$sysSession->school_id.'/door/wmhelp/'.$sysSession->lang.'/assets/';
...
*/
$IMConfig['base_url'] = 'http://wm3.learn.com.tw/base/'.$sysSession->school_id.'/door/wmhelp/'.$sysSession->lang.'/assets/';
