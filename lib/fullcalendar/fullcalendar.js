...
//if (window.console) {console.log('renderEvents', segs);}
...
//                if (window.console) {console.log('bgSegs', bgSegs);}
                
//                if (window.console) {console.log('fgSegs-1', fgSegs);}
                
                
		fgSegs = this.renderFgSegs(fgSegs) || fgSegs;
                
//                if (window.console) {console.log('fgSegs-2', fgSegs);}

		this.segs = bgSegs.concat(fgSegs);
                
//                if (window.console) {console.log(this.segs);}
...
//if (window.console) {console.log('renderFgSegEls', segs.length);}
...
//if (window.console) {console.log('el', el);}
...
//            if (window.console) {console.log('renderFgSegs');}
...
//                if (window.console) {console.log('segs-1', segs);}
                
                
		segs = this.renderFgSegEls(segs);
//                if (window.console) {console.log('segs-2', segs);}
	...
	display: function(date) {
		...
		if (this.displaying) {
			scrollState = this.queryScroll();
                ...
                // 判斷 個人、課程、學校 行事曆清單 是否剩下一個，如果只剩下一個，強制顯示該月曆並隱藏右側清單區塊
                if ($('#newcalendar_flag').find("li[style='display: none;']").length === 2) {
                    // 隱藏右側清單
                    $('#newcalendar_leftNav').hide();
                }
					...
					if (buttonName == 'title') {
						...
						if (buttonClick) {
							...
							if (overrideText) {
								...
								innerHtml = "<span class='fc-icon icon-chevron-" + normalIcon + "'></span>";
							}
							else {
