	 ...
	 *
	 * @author: lst
	 * @version: $Id: dragLayer.js,v 1.1 2010/02/24 02:39:33 saly Exp $
	 **/
	...
	function Mv2View(objName) {
		...
		sclTop    = parseInt(document.body.scrollTop);   // 捲動軸 Top
		sclLeft   = parseInt(document.body.scrollLeft);  // 捲動軸 Left
	...
	function getVisib(obj) {
		...
		if (!value) {
			if (document.defaultView && typeof(document.defaultView.getComputedStyle) == "function") {
				...
				if (!/Konqueror|Safari|KHTML/i.test(navigator.userAgent)) value = document.defaultView.getComputedStyle(obj, "").getPropertyValue("visibility");
				else value = "";
