<?php
	/**
	 * 學校統計資料 - 登入次數統計 - 週報表 - 長條圖
	 * 建立日期：2004/08/16
	 * @author  Amm Lee
	 * @version $Id: login_week_graph.php,v 1.1 2010/02/24 02:38:43 saly Exp $
	...
	$graph->setGraphTitle($MSG['title8'][$sysSession->lang]);
	$graph->setXaxisTitle($MSG['week'][$sysSession->lang], 150);
