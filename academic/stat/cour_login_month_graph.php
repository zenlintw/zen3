<?php
	/**
	 * 學校統計資料 - 上課次數統計 - 月報表 - 長條圖
	 * 建立日期：2004/08/16
	 * @author  Amm Lee
	 * @version $Id: cour_login_month_graph.php,v 1.1 2010/02/24 02:38:42 saly Exp $
	...
	$graph->setMargin(85, 30, 50, 50);
	$graph->setGraphTitle($MSG['title15'][$sysSession->lang]);
