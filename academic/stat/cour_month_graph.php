<?php
     ...
     * 建立日期：2004/08/16
     * @author  Amm Lee
     * @version $Id: cour_month_graph.php,v 1.1 2010/02/24 02:38:43 saly Exp $
    ...
    $graph->setMargin(130, 40, 60, 50);
    $graph->setGraphTitle($MSG['title5'][$sysSession->lang]);
    $graph->setXaxisTitle($MSG['month'][$sysSession->lang], 100);
