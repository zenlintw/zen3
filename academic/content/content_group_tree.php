<?php
	...
	*       $Id: content_group_tree.php,v 1.1 2010/02/24 02:38:16 saly Exp $                                                                                           *
	**************************************************************************************************/
	...
	$content_id = isset($_GET['a']) ? intval($_GET['a']) : '';
 ...
 // //////////////////////////////////////////////////////////////////////////
	...
	function getNode(gid) {
		...
		nodes = xmlVars.getElementsByTagName("contents");
	...
	function buildGP(gid, indent) {
		...
		for (var i = 0; i < cnt; i++) {
			...
			if (nodes[i].nodeName == "contents") {
				...
				// icon
				childs = nodes[i].getElementsByTagName("contents");
	...
	function showRoot(content_id) {
		...
		parent.main.loadCS(content_id, true);
	}
