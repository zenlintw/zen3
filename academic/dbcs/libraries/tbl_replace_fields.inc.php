 ...
 *
 * @version $Id: tbl_replace_fields.inc.php,v 1.1 2010/02/24 02:38:26 saly Exp $
...
$me_fields_upload =
    ...
    : (isset($_FILES['fields_upload_' . $key]['tmp_name'])
        ...
        : 'none'));
$me_fields_upload = mb_convert_encoding($me_fields_upload, 'utf-8', 'utf-8,cp950,gb2312,gbk,JIS,eucjp-win,sjis-win');
