<?php
	 ...
	 * @since   2004/11/17
	 * @author  ShenTing Lin
	 * @version $Id: course_tree.php,v 1.1 2010/02/24 02:38:20 saly Exp $
	...
	$isCheckbox = (defined('Mail2Group')) ? 'false' : 'true';
...
// ////////////////////////////////////////////////////////////////////////////
	...
	function buildGroup(gid, indent) {
		...
		for (var i = 0; i < cnt; i++) {
			...
			if (isCheckbox) txt += '<input type="checkbox" name="gids[]" value="' + idx + '">';
						...
						showXHTML_tr_B('class="cssTrEvn"');
							showXHTML_td_B('colspan="2" nowrap="nowrap"');
								...
								//if ($sysSession->cur_func == $msgFuncID['notebook']) {
									...
									// showXHTML_input('checkbox', 'gids[]', $csid, '', '');
									echo $txt;
								// } else {
