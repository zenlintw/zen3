<?php
    ...
    **************************************************************************************************/
    ...
    $RS = dbGetStSr('WM_user_account', '*', "username='" . $username . "'", ADODB_FETCH_ASSOC);
    ...
    showXHTML_table_B('width="760" border="0" cellspacing="1" cellpadding="3" id="stud_info" class="cssTable"');
        ...
        showXHTML_tr_B($col);
                ...
                showXHTML_td_B('align="center" rowspan="5" width="100"');
                    echo '<span id="PicRoom"><img src="showpic.php?a=' , $enc_username , '&timestamp=' . uniqid('') . '" type="image/jpeg" id="MyPic" width="100px" name="MyPic" borer="0" align="absmiddle" onload="picReSize()" loop="0"></span>';
                showXHTML_td_E();
        showXHTML_tr_E();
