<?php
	 ...
	 * @since   2004/04/06
	 * @author  ShenTing Lin
	 * @version $Id: sysbar_new.php,v 1.1 2010/02/24 02:38:46 saly Exp $
	...
	if (!aclVerifyPermission(1900100100, aclPermission2Bitmap('enable,visible,readable,writable,modifiable,uploadable,removable')))
	{
	}
