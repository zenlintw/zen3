...
CREATE DATABASE /*!32312 IF NOT EXISTS*/ `MOOCLITE20P2_MASTER` /*!40100 DEFAULT CHARACTER SET utf8 */;

USE `MOOCLITE20P2_MASTER`;
...
INSERT INTO `WM_all_account` (`username`, `password`, `enable`, `first_name`, `last_name`, `gender`, `birthday`, `personal_id`, `email`, `homepage`, `home_tel`, `home_fax`, `home_address`, `office_tel`, `office_fax`, `office_address`, `cell_phone`, `company`, `department`, `title`, `language`, `theme`, `msg_reserved`, `hid`) VALUES 
	('root','178eed98a141d2c8f78a460e225d488a','Y','管理員','系統','M','1970-01-01','','root@localhost','','07-1234123','','','','','','','','','','Big5','default',0,130968);
...
INSERT INTO `WM_manager` (`username`, `school_id`, `level`, `allow_ip`) VALUES 
	('root',10001,8192,'192.168.10 220.132.29.71');
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/ `MOOCLITE20P2_10001` /*!40100 DEFAULT CHARACTER SET utf8 */;

USE `MOOCLITE20P2_10001`;
...
CREATE TABLE `WM_history_qti_exam_result` (
  ...
  `status` enum('submit','break','revised','publish') default NULL,
...
CREATE TABLE `WM_history_user_account` (
  ...
  `msg_reserved` tinyint(1) NOT NULL default '0',
  `hid` int(10) unsigned NOT NULL default '262075',
  `user_status` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci default NULL,
  `education` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci default NULL,
...
GRANT SELECT, INSERT, UPDATE, DELETE, INDEX, ALTER, CREATE on `MOOCLITE20P2\_%`.*  TO wm3@localhost IDENTIFIED BY 'WmIiI';
