        ...
        <div style="height:85%;background:rgba(255,255,255,0.80);">
            <div class="container" style="max-width:750px;height:85%;">
                ...
                <div class="row" style="margin-top:5rem;margin-bottom:5rem;">
                    <div class="col-md-12" style="color: #455868;font-size:2.5rem;letter-spacing: -2px;font-weight:Bold;text-align:center;">{'already_submit'|WM_Lang}</div>
                </div>
                
                <div class="row" style="margin-top:2.5rem;">
                    <div class="col-md-3 col-xs-2"></div>
                    <div class="col-md-6 col-xs-8" style="border: 1px solid #E8483F;border-radius: 100px;color:#E8483F;font-size:2rem;letter-spacing:-0.38px;font-weight:Bold;text-align:center;" onclick="location.replace('/mooc/user/code.php');">回加入互動頁面</div>
                    <div class="col-md-3 col-xs-2"></div>
                </div>
