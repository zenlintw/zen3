<div id="item{$serinal}" class="container {if ($serinal!==1)}hidden{/if}">
    ...
    <div class="col-md-12 correct_item correct{$serinal}" onclick="correct(this,{$serinal})">
        <div class="true_icon"></div>
        <input type="radio" value="O" name="ans[{$data.item_id}][{$data.type}]" style="display:none;"/>
    </div>

    

    <div class="col-md-12 correct_item correct{$serinal}" onclick="correct(this,{$serinal})">
        <div class="false_icon"></div>
        <input type="radio" value="X" name="ans[{$data.item_id}][{$data.type}]" style="display:none;"/>
    </div>
