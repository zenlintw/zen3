...
<link href="/public/css/mycourse/site.css?{$smarty.now}" rel="stylesheet">
<link href="/public/css/mycourse/tooltip.css?{$smarty.now}" rel="stylesheet">
<link href="/public/css/mycourse/mycourse.css?{$smarty.now}" rel="stylesheet">
<style type="text/css">
{literal}
#BlockContainer {
    margin-top: 40px;
...
<div id="BlockContainer" class="container">
    <div class="row">
        <div class="block-title-font col-md-12" style=""><i class="fa fa-university" aria-hidden="true" style="font-size:26px;margin-left:0.5em;margin-right:0.5em;"></i>我的課程</div>
    </div>
    <div class="row">
        ...
        <div id="mycourse-container">
            <div id="listtype_list_container">
                <div id="listtype_list_content">
                    ...
                    <div class="container hidden-xs" style="width:510px;">
                    ...
                    <div class="container hidden-lg hidden-md hidden-sm visible-xs" style="width:100%;">
                        <div class="message" style="color: #393939;font-size: 16px;font-weight: bold;">您目前無任何課程</div>
                    </div>
                    {else}
                    ...
                    <div class="mycourse-table">
                        <div class="tb-row" style="background-color: #F8F8F8;">
                                ...
                                <div class="col-md-12" style="padding-bottom: 15px">
                                    <div class="row" style="margin: 0px;padding:0px;width:100%;border: 1px solid #C9C9C9">
                                        <div class="col-md-12" style="margin: 0px;padding:0px;">
                                            <a href="javascript: void(0);" onclick="gotoCourse({$v.course_id})"><img src="/lib/app_show_course_picture.php?courseId={$v.cpic}&now={$smarty.now|date_format:"%Y%m%d%H"}{*整點更新一次*}" alt="課程代表圖" style="width:100%" /></a>
                                            {*{if $v.category eq 1}
                            ...
                            <div class="cell col-xs-12 col-md-8 col-sm-8">
                                <div class="col-md-12">
                                    <h3 class="ml15">
                                        <a href="javascript: void(0);" onclick="gotoCourse({$v.course_id})">{$v.caption}</a>
                                    </h3>
                                    <hr>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-12 ">
                                    <div class="cell col-xs-12 col-sm-6 col-md-4">
                                        <div>
                                            <ul style="margin-left: 0; margin-top: 0.7em;">
                                            講師：{$v.teacher}
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="cell col-xs-12 col-sm-6 col-md-3" style="">
                                    </div>
                                    <div class="cell col-xs-12 col-sm-6 col-md-5">
                                        <div class="openingperiod">
                                            <i class="fa fa-clock-o ic-clock" aria-hidden="true"></i>開課期間：{$v.classPeriod}
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<form name="formMyCourseQuery" method="POST" action="/mooc/user/mycourse.php">
...
<script type="text/javascript" src="/mooc/public/js/mycourse_phone.js"></script>
