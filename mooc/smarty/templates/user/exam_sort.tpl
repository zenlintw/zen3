...
<div id="BlockContainer" class="container">
    ...
    <div id="back"> 
	    <div class="title">
	        <div class="col-xs-6">
	        <a href="#" style="color:#FFFFFF" onclick="goEdit('{$exam_id}','{$type}');"><div style="float:left;position:absolute;">&nbsp;&nbsp;&nbsp;&nbsp;<i class="far fa-arrow-alt-circle-left"></i>&nbsp;&nbsp;返回編輯</div></a>
	        </div>
	        <div class="col-xs-6">
