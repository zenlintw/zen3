    ...
    <div class="container" style="max-width: 360px;">
        <div class="row" style="margin: 0 auto;">
            <div class="col-md-12 col-xs-12" style="text-align: center;border-bottom: 1px solid #dfdfdf;">
                <span class="t28">{'btn_query_password'|WM_Lang}</span></div>
        </div>
    </div>
</div>
<form onsubmit="return checkData();" id="formForget" action="{$appRoot}/mooc/forget_p.php" method="post" name="formForget" accept-charset="UTF-8" lang="zh-tw">
...
<div id="loginBlockContainer">
    ...
    <div id="divLoginByAccount" class="container">
        <div class="row" style="margin:0 auto;">
            <input type="text" id="username" name="username" class="t14_b input-text" placeholder="{'th_username'|WM_Lang}" value="{$prev_fill_username}">
        </div>
        <div class="row" style="margin:0 auto;">
            <input type="text" id="email" name="email" class="t14_b input-text" placeholder="{'ex_email'|WM_Lang}" value="{$prev_fill_email}">
        </div>
...
<script type="text/javascript" src="{$appRoot}/mooc/public/js/forget.js?adfadfasf"></script>
<script type="text/javascript">
    username = '{$prev_fill_username}';
    email = '{$prev_fill_email}';
</script>
