...
(function(root, factory) {
    ...
    $.jPlayer.prototype = {
        ...
        format: { // Static Object
            ...
            mpdv: { //MPEG-DASH
                ...
                flashCanPlay: false,
                htmlCanPlay: !!(window.dashjs && (window.WebKitMediaSource || window.MediaSource)),
                isDash: true,
                media: 'video'
            }
        },
        ...
        _refreshSize: function() {
            ...
            this._updateButtons();
            //custom
            //當IE8~10時不隱藏控制列(因為隱藏後無法監聽flash mouse事件,就無法顯示)
            if (($.jPlayer.browser.msie && (Number($.jPlayer.browser.version) < 11 || $.jPlayer.browser.documentMode < 11))) {
        ...
        _updateAutohide: function() {
            var self = this,
                ...
                handler = function() {
                    //ivq全營幕時不顯示play-bar
                    if ($(this).find('.ivq-iframe').css('display') != undefined) {
                        if ($(this).find('.ivq-iframe').css('display') == 'block') {
                            return false;
                        }
                    }
    ...
    if(this.html.dash) {
                ...
                console.log('autoSwitch:'+dashPlayer.getAutoSwitchQualityFor('video'));
            }
